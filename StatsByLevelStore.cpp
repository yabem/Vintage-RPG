...
void StatsByLevelStore::loadAllCharacterStats(){
    ...
    lancer->loadLevelStats(1 , 100 , 1 , 100 , 10 , 4 , 2.0 , 0);
    lancer->loadLevelStats(2 , 150 , 1 , 150 , 12 , 5 , 2.0 , 200);
    lancer->loadLevelStats(3 , 200 , 2 , 21 , 14 , 6 , 1.9 , 500);
    lancer->loadLevelStats(4 , 250 , 2 , 28 , 16 , 7 , 1.8 , 800);
    lancer->loadLevelStats(5 , 300 , 3 , 36 , 18 , 8 , 1.7 , 1100);
    lancer->loadLevelStats(6 , 350 , 3 , 45 , 20 , 9 , 1.6 , 1400);
    lancer->loadLevelStats(7 , 400 , 4 , 55 , 22 , 10 , 1.5 , 1700);
    lancer->loadLevelStats(8 , 450 , 4 , 66 , 24 , 11 , 1.4 , 2000);
    lancer->loadLevelStats(9 , 500 , 5 , 78 , 26 , 12 , 1.3 , 2300);
    lancer->loadLevelStats(10 , 550 , 5 , 91 , 28 , 13 , 1.2 , 2600);
    ...
    warrior->loadLevelStats(1 , 100 , 1 , 100 , 5 , 4 , 2.0 , 0);
    warrior->loadLevelStats(2 , 200 , 1 , 140 , 6 , 5 , 1.9 , 200);
    warrior->loadLevelStats(3 , 300 , 2 , 18 , 7 , 6 , 1.8 , 500);
    warrior->loadLevelStats(4 , 400 , 2 , 23, 8 , 7 , 1.8 , 800);
    warrior->loadLevelStats(5 , 500 , 3 , 28 , 9 , 8 , 1.7 , 1100);
    warrior->loadLevelStats(6 , 600 , 3 , 34 , 10 , 9 , 1.6 , 1400);
    warrior->loadLevelStats(7 , 700 , 4 , 40 , 11 , 10 , 1.5 , 1700);
    warrior->loadLevelStats(8 , 800 , 4 , 47 , 12 , 11 , 1.4 , 2000);
    warrior->loadLevelStats(9 , 900 , 5 , 55 , 13 , 12 , 1.3 , 2300);
    warrior->loadLevelStats(10 , 1000 , 5 , 64 , 14 , 13 , 1.2 , 2600);
    ...
    thief->loadLevelStats(1 , 100 , 1 , 200 , 10 , 4 , 1.9 , 0);
    thief->loadLevelStats(2 , 130 , 1 , 300 , 15 , 5 , 1.9 , 200);
    thief->loadLevelStats(3 , 160 , 2 , 40 , 20 , 6 , 1.8 , 500);
    thief->loadLevelStats(4 , 190 , 2 , 50 , 25 , 7 , 1.8 , 800);
    thief->loadLevelStats(5 , 220 , 3 , 60 , 30 , 8 , 1.7 , 1100);
    thief->loadLevelStats(6 , 250 , 3 , 70 , 35 , 9 , 1.6 , 1400);
    thief->loadLevelStats(7 , 280 , 4 , 80 , 40 , 10 , 1.5 , 1700);
    thief->loadLevelStats(8 , 310 , 4 , 90 , 50 , 11 , 1.4 , 2000);
    thief->loadLevelStats(9 , 340 , 5 , 110 , 55 , 12 , 1.3 , 2300);
    thief->loadLevelStats(10 , 370 , 5 , 120 , 60 , 13 , 1.2 , 2600);
    ...
    mage->loadLevelStats(1 , 100 , 1 , 10 , 200 , 4 , 1.8 , 0);
    mage->loadLevelStats(2 , 125 , 1 , 12 , 270 , 5 , 1.8 , 200);
    mage->loadLevelStats(3 , 150 , 2 , 14 , 34 , 6 , 1.8 , 500);
    mage->loadLevelStats(4 , 175 , 2 , 15 , 41 , 7 , 1.8 , 800);
    mage->loadLevelStats(5 , 200 , 3 , 16 , 48 , 8 , 1.7 , 1100);
    mage->loadLevelStats(6 , 225 , 3 , 17 , 59 , 9 , 1.6 , 1400);
    mage->loadLevelStats(7 , 250 , 4 , 18 , 70 , 10 , 1.5 , 1700);
    mage->loadLevelStats(8 , 275 , 4 , 19 , 81 , 11 , 1.4 , 2000);
    mage->loadLevelStats(9 , 300 , 5 , 20 , 92 , 12 , 1.3 , 2300);
    mage->loadLevelStats(10 , 325 , 5 , 21 , 103 , 13 , 1.2 , 2600);
