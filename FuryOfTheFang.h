//FuryOfTheFang positions the character in front of the enemy and
//attacks for damage.
...
class FuryOfTheFang : public CharacterManipulation{
...
public:
    ...
    FuryOfTheFang();      //Default constructor.
    ~FuryOfTheFang();     //Destructor.
