...
HomeTownBattleScreen::HomeTownBattleScreen(ImageStore *imageStore){

    this->imageStore = imageStore;
    this->sizeOfBattleCutsceneLayout = BATTLE_SCREEN_LAYOUT_SIZE;
}

HomeTownBattleScreen::~HomeTownBattleScreen(){
...
void HomeTownBattleScreen::loadAllMapConfigurationsForLayers(){

    loadBackgroundLayerConfiguration();
}

void HomeTownBattleScreen::loadBackgroundLayerConfiguration(){
...
void HomeTownBattleScreen::deleteAllLayerConfigurations(){

    delete this->backgroundLayerLayout;
    this->backgroundLayerLayout = NULL;
}

void HomeTownBattleScreen::loadDefaults(){
